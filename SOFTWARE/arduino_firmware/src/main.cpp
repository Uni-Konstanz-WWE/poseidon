...
#define X_SPEED 100000 // X steps per second
...
#define EN        0       // stepper motor enable, low level effective (note put jumper so automatic)

#define X_DIR     0       // X axis, direction pin
#define Y_DIR     0       // Y
#define Z_DIR     0       // Z

#define X_STP     0       // X axis, step pin
#define Y_STP     0       // Y
#define Z_STP     0       // Z
...
//AccelStepper stepper1(AccelStepper::FULL4WIRE, 2, 3, 1, 4);
